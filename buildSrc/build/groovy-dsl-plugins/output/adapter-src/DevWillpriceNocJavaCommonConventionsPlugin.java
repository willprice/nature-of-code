...
/**
 * Precompiled dev.willprice.noc.java-common-conventions script plugin.
 **/
public class DevWillpriceNocJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_DevWillpriceNocJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DevWillpriceNocJavaCommonConventions").asSubclass(BasicScript.class);
