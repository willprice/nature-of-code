...
/**
 * Precompiled dev.willprice.noc.java-application-conventions script plugin.
 **/
public class DevWillpriceNocJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_DevWillpriceNocJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("dev.willprice.noc.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DevWillpriceNocJavaApplicationConventions").asSubclass(BasicScript.class);
